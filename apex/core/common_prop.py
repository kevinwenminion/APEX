...
from apex.core.property.factory import make_property_instance as make_property_instance_factory
...
def make_property_instance(parameters, inter_param):
    ...
    if prop_type == "gruneisen":
        return Gruneisen(parameters, inter_param)
    return make_property_instance_factory(parameters, inter_param)
